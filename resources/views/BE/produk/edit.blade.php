            ...
            <div class="card shadow mb-4">
              ...
              <div class="card-body">
                <div class="mb-3">
                  ...
                  <input required value="{{ $produk->nama }}" type="text" name="nama" class="form-control" id="judulArtikelBahasa" placeholder="masukkan nama produk">
                  <little><sup>*</sup> wajib</little>
                </div>
                <div class="mb-3">
                    <label for="">Keterangan</label>
                    <textarea id="editor" name="keterangan">{{ $produk->keterangan }}</textarea>
                  <little><sup>*</sup> wajib</little>
                </div>
              </div>
            </div>
