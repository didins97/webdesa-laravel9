...
@section('header', 'Edit Potensi Desa')

@section('content')
<form action="{{ route('potensi_desa.update', $potensi->id) }}" method="POST" enctype="multipart/form-data">
    @csrf @method('PATCH')
    <!-- Begin Page Content -->
            ...
            <div class="card shadow mb-4">
              ...
              <div class="card-body">
                <div class="mb-3">
                  ...
                  <input required value="{{ $potensi->nama }}" type="text" name="nama" class="form-control" id="judulArtikelBahasa" placeholder="masukkan nama benda">
                  <p style="color: red"><sup>*</sup> wajib</p>
                </div>
                <div class="mb-3">
                    <label for="">Keterangan</label>
                    <textarea id="editor" name="keterangan">{{ $potensi->keterangan }}</textarea>
                    <p style="color: red"><sup>*</sup> wajib</p>
                </div>
              </div>
            </div>
            ...
            `<div class="col-md-12 wrapper-foto-slider mb-3" data-id="` + i + `">
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="row">
                      <div class="col-12 mb-2">
                        <input class="form-control" name="galleries_foto[]" id="uploadThumbnail" type="file" data-preview=".sliderPreview` + i + `" accept="image/png, image/jpeg">
                        <p style="color: red"><sup>*</sup> wajib</p>
                      </div>
                    </div>
                  </div>
